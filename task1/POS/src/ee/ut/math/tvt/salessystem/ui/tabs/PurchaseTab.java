...
public class PurchaseTab {
	...
	public boolean createPopup() {
		final JDialog confirmationDialog = new JDialog();
		...
		JPanel confirmPanel = new ConfirmOrderPanel(model, confirmationDialog);

		confirmPanel.setBorder(BorderFactory
				.createTitledBorder("Confirm order: "));
		confirmationDialog.add(confirmPanel);

		confirmationDialog.pack();
		confirmationDialog.setLocationByPlatform(true);
		confirmationDialog.setVisible(true);
		confirmationDialog.setResizable(false);
		if (ConfirmOrderPanel.isReturnValue() == true) {
			return true;
		} else
			return false;
